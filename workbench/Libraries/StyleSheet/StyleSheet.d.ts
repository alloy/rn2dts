...
type TypeForStyleKey<key extends $Keys<____DangerouslyImpreciseStyle_Internal>> = $ElementType<____DangerouslyImpreciseStyle_Internal, key>;
...
export { ViewStyleProp };

export { TextStyleProp };

export { ImageStyleProp };

export { DangerouslyImpreciseStyleProp };

export { TypeForStyleKey };
...
export { DangerouslyImpreciseStyle };
...
declare module.exports: {
  ...
  /**
     ...
     */
  create<S extends ____Styles_Internal>(obj: S): UniqueBranding & Readonly<S>;
}