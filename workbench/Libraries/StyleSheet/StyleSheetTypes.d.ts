...
type ColorArrayValue = null | ReadonlyArray<ColorValue>;
...
type DimensionValue = null | number | string | AnimatedNode;

type ____LayoutStyle_Internal = UniqueBranding & Readonly<{
...
type ____TransformStyle_Internal = UniqueBranding & Readonly<{
  ...
  } | {readonly skewX: string;} | {readonly skewY: string;} | {readonly matrix: ReadonlyArray<number | AnimatedNode> | AnimatedNode;}>;
}>;

type ____ShadowStyle_Internal = UniqueBranding & Readonly<{
  ...
  /**
     ...
     * @platform ios
     */
  shadowOffset?: UniqueBranding & Readonly<{width?: number;height?: number;}>;
...
type ____ViewStyle_Internal = UniqueBranding & Readonly<$Exact<____LayoutStyle_Internal> & $Exact<____ShadowStyle_Internal> & $Exact<____TransformStyle_Internal> & {
...
type ____FontWeight_Internal = "normal" | "bold" | "100" | "200" | "300" | "400" | "500" | "600" | "700" | "800" | "900";

type ____TextStyle_Internal = UniqueBranding & Readonly<$Exact<____ViewStyle_Internal> & {
  color?: ColorValue;
  fontFamily?: string;
  fontSize?: number;
  ...
  textShadowOffset?: UniqueBranding & Readonly<{width: number;height: number;}>;
...
type ____ImageStyle_Internal = UniqueBranding & Readonly<$Exact<____ViewStyle_Internal> & {
  resizeMode?: "contain" | "cover" | "stretch" | "center" | "repeat";
  tintColor?: ColorValue;
  overlayColor?: string;
}>;

type ____DangerouslyImpreciseStyle_Internal = $Exact<____TextStyle_Internal> & {
...
type ____DangerouslyImpreciseStyleProp_Internal = GenericStyleProp<$Shape<____DangerouslyImpreciseStyle_Internal>>;
type ____ViewStyleProp_Internal = GenericStyleProp<UniqueBranding & Readonly<$Shape<____ViewStyle_Internal>>>;
type ____TextStyleProp_Internal = GenericStyleProp<UniqueBranding & Readonly<$Shape<____TextStyle_Internal>>>;
type ____ImageStyleProp_Internal = GenericStyleProp<UniqueBranding & Readonly<$Shape<____ImageStyle_Internal>>>;

type ____Styles_Internal = {
  readonly [key: string]: $Shape<____DangerouslyImpreciseStyle_Internal>;
};
export { ColorValue };
export { ColorArrayValue };
export { PointValue };
export { EdgeInsetsValue };
export { DimensionValue };

export { ____ShadowStyle_Internal };

export { ____ViewStyle_Internal };

export { ____FontWeight_Internal };

export { ____TextStyle_Internal };

export { ____ImageStyle_Internal };

export { ____DangerouslyImpreciseStyle_Internal };

export { ____DangerouslyImpreciseStyleProp_Internal };
export { ____ViewStyleProp_Internal };
export { ____TextStyleProp_Internal };
export { ____ImageStyleProp_Internal };

export { ____Styles_Internal };