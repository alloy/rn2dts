...
type ScrollResponderType = typeof ScrollResponder.Mixin & {
...
type IOSProps = UniqueBranding & Readonly<{
  ...
  /**
     ...
     * @platform ios
     */
  maintainVisibleContentPosition?: (UniqueBranding & Readonly<{minIndexForVisible: number;autoscrollToTopThreshold?: number | null | undefined;}>) | null | undefined;
...
type VRProps = UniqueBranding & Readonly<{
...
type StickyHeaderComponentType = React.AbstractComponent<ScrollViewStickyHeaderProps, UniqueBranding & Readonly<{setNextHeaderY: ((arg0: number) => void);}>>;

type Props = UniqueBranding & Readonly<ViewProps & IOSProps & AndroidProps & VRProps & {
  /**
...
declare class ScrollView extends React.Component<Props, State> {
  ...
  getInnerViewRef(): React.ElementRef<typeof View> | null | undefined;
  ...
  /**
     ...
     */
  scrollTo(options?: {x?: number;y?: number;animated?: boolean;} | number, deprecatedX?: number, deprecatedAnimated?: boolean): void;
  ...
  /**
     ...
     */
  scrollToEnd(options?: {animated?: boolean;} | null | undefined): void;
...
export { ScrollResponderType };

export { Props };

declare module.exports: typeof ScrollView