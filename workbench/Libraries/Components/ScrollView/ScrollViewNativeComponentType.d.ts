...
type ScrollViewNativeProps = UniqueBranding & Readonly<ViewProps & {
...
type ScrollViewNativeComponentType = HostComponent<ScrollViewNativeProps>;
export { ScrollViewNativeProps };

export { ScrollViewNativeComponentType };