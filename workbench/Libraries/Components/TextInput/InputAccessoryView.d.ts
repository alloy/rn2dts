...
declare type _typeof_DeprecatedColorPropType = typeof _valueof_DeprecatedColorPropType & UniqueBranding;
/**
 * Note: iOS only
 *
 ...
 */
declare type DeprecatedColorPropType = ClassOrType<_typeof_DeprecatedColorPropType>;
