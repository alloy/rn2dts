...
type Props<ItemT> = $Diff<VirtualizedListProps, {
...
declare var defaultProps: typeof VirtualizedList.defaultProps & {
  numColumns: number;
...
declare class FlatList<ItemT> extends React.PureComponent<Props<ItemT>, void> {
  ...
  /**
     ...
     * `getItemLayout` prop.
     */
  scrollToItem(params: {animated?: boolean | null | undefined;item: ItemT;viewPosition?: number;}): void;
