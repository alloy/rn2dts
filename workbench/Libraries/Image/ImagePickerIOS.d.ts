...
declare var ImagePickerIOS: {
  ...
  openCameraDialog: ((config: UniqueBranding & Readonly<{unmirrorFrontFacingCamera?: boolean;videoMode?: boolean;}>, successCallback: ((imageURL: string, height: number, width: number) => void), cancelCallback: (() => void)) => void);
  openSelectDialog: ((config: UniqueBranding & Readonly<{showImages?: boolean;showVideos?: boolean;}>, successCallback: ((imageURL: string, height: number, width: number) => void), cancelCallback: (() => void)) => void);
