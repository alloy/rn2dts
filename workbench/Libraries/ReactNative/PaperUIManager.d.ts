declare const UIManagerJS: {
    ...
    findSubviewIn: (reactTag: number | null | undefined, point: any, callback: (nativeViewTag: number, left: number, top: number, width: number, height: number) => void) => void;
    dispatchViewManagerCommand: (reactTag: number | null | undefined, commandID: number, commandArgs: any) => void;
    ...
    viewIsDescendantOf: (reactTag: number | null | undefined, ancestorReactTag: number | null | undefined, callback: (result: any) => void) => void;
    ...
    setChildren: (containerTag: number | null | undefined, reactTags: any) => void;
    manageChildren: (containerTag: number | null | undefined, moveFromIndices: any, moveToIndices: any, addChildReactTags: any, addAtIndices: any, removeAtIndices: any) => void;
    setLayoutAnimationEnabledExperimental: (enabled: boolean) => void;
    sendAccessibilityEvent: (reactTag: number | null | undefined, eventType: number) => void;
    showPopupMenu: (reactTag: number | null | undefined, items: any, error: (error: any) => void, success: (event: string, selected?: number | undefined) => void) => void;
